...
DOCUMENT_KEYWORDS = {
    'счёт': [
        'счёт', 'счет', 'invoice', 'bill', 'счёт-фактура', 'счет-фактура'
    ],
    'акт': [
    ...
    'платёжное поручение': [
        'платёжное поручение', 'платежное поручение', 'платежное', 'платёжное',
        'payment order', 'п/п', 'п\u0002Fп', 'платежка', 'платёжка',
        'платежное поручение', 'платёжное поручение', 'платежное поручение',
        'платежное', 'платёжное', 'платежка', 'платёжка',
        'ПЛАТЕЖНОЕ ПОРУЧЕНИЕ', 'ПЛАТЁЖНОЕ ПОРУЧЕНИЕ', 'ПЛАТЕЖКА', 'ПЛАТЁЖКА'
    ]
}
